...
export function Academlo() {
  ...
  const [main2, setMain2] = useState(
    "text-black bg-zinc-800 h-full mt-4 absolute top-[0.5rem] pt-8 border-zinc-800 w-full"
  );
  const [acabtn1, setAcabtn1] = useState(
    "absolute top-[15rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded"
  );

  const [acabtn2, setAcabtn2] = useState(
    "absolute top-[10rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded"
  );
  ...
  const toggleDarkMode = () => {
    ...
    setMain2(
      selectedDark === 1
        ? "text-black bg-zinc-800 h-full mt-4 absolute top-[0.5rem] pt-8 border-zinc-800 w-full"
        : "text-zinc-800 bg-black h-full mt-4 absolute top-[0.5rem] pt-8 border-black w-full"
    );
    ...
    setAcabtn1(
      selectedDark === 1
        ? "absolute top-[15rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded"
        : "absolute top-[15rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-black font-bold py-2 px-4 rounded"
    );
    ...
    setAcabtn2(
      selectedDark === 1
        ? "absolute top-[10rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded"
        : "absolute top-[10rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-black font-bold py-2 px-4 rounded"
    );
  ...
  return (
    <div>
      <section
        id="acamain2"
        className={`text-black bg-zinc-800 h-full mt-4 absolute top-[0.5rem] pt-8 border-black w-full`}
      >
        <button
          id="acabtn1"
          className="absolute top-[15rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded"
        >
        ...
        <button
          id="acabtn2"
          className="absolute top-[10rem] left-[5rem] bg-zinc-500 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded"
        >
        ...
        <h3
          className="absolute left-[19vw] bottom-[10vh] transition-all duration-300 hover:text-zinc-500"
